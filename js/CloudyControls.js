 ...
 *
 * @ modified by mattire:
 *  moving&turning by keyboard controls
 */


THREE.CloudyControls = function ( _object, meshList, domElement ) {
	...
	this.onKeyDown = function ( event ) {
		...
		if(!isShift){
			switch ( event.keyCode ) {
				case 49: /*1*/ this.incSpeed = true; break;
				case 50: /*2*/ this.decSpeed = true; break;

				case 51: this.incLookSpeed = true; break;
				case 52: this.decLookSpeed = true; break;
	...
	this.onKeyUp = function ( event ) {
		...
		if(!isShift){
			switch ( event.keyCode ) {
				...
				case 49: /*1*/ this.incSpeed = false; break;
				case 50: /*2*/ this.decSpeed = false; break;

				case 51: this.incLookSpeed = false; break;
				case 52: this.decLookSpeed = false; break;
